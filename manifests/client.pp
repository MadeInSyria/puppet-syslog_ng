...
class syslog_ng::client inherits syslog_ng {
    ...
    file { 
        "/etc/syslog-ng/syslog-ng.conf":
            ...
            content => [template("syslog_ng/syslog-ng.conf.client.$hostname.erb"),
                        template("syslog_ng/syslog-ng.conf.client.$environement.erb"),
                        template("syslog_ng/syslog-ng.conf.client.erb")];
